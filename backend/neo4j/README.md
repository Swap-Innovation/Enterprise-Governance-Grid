...
Runnable **Neo4j** setup that materializes [`contracts/`](../../contracts/) as a knowledge graph: Business Catalog · Technical Catalog · Data Products · Semantic Control Plane, with cross-pack bridges and the Customer 360 end-to-end flow.
...
| [`../../docs/kg/neo4j/00. README.md`](../../docs/kg/neo4j/00.%20README.md) | Section hub |
| [`../../docs/kg/neo4j/01. Graph Model.md`](../../docs/kg/neo4j/01.%20Graph%20Model.md) | Labels, relationships, pack mapping |
| [`../../docs/kg/neo4j/02. Setup And Run.md`](../../docs/kg/neo4j/02.%20Setup%20And%20Run.md) | Ops guide |

## What gets loaded

Multi-NATCO **Customer 360** from contracts Semantic Control Plane examples (and Cypher e2e seeds):
